...
DELTA                       =      0.01              #   How much should the epsilon shift by in every game
LR                          =      0.01          #   This is the learning rate. High learning rate means faster learning"                     
GAMMA                       =      0.95              #   gamma = discount factor. High gamma value means focus on future rewards "
STARTING_EPSILON            =      1
...
NO_DESTRUCTION              =      -500                
NO_KILL                     =      -1000            
PLACING_BOMBS_WITH_NO_AMMO  =      -250
BOMB_IN_RANGE               =      10
PLACING_BOMB_ON_TOP_OF_BOMB =      -2000
EXIST_PENALTY               =      -25
...
GUIDANCE                    =       0.3                        # 1 means the agent copies exactly as the coach. 0 means that the agent makes random moves Should be between 1 and 0
